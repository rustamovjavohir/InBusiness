...
class Specialization(models.Model):
    name = models.CharField(_("specialization name"), max_length=250, blank=False, null=False)
...
class User(AbstractBaseUser, PermissionsMixin):  # PermissionsMixin
    ...
    profile_image = models.ImageField(max_length=255,upload_to='users', blank=True, null=True)
